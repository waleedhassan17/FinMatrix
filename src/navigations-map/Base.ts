export const ROUTES = {
  ...
  ADD_BANK_TRANSACTION: 'AddTransaction',
  BANK_TRANSFER: 'Transfer',
  BANK_RECONCILIATION: 'Reconciliation',
  BANK_RECONCILIATION_HISTORY: 'ReconciliationHistory',
  ...
  CREDIT_MEMO_FORM: 'CreditMemoForm',
  ...
  PAY_BILLS: 'PayBills',
  VENDOR_CREDIT_FORM: 'VendorCreditForm',
  PO_LIST: 'POList',
  PO_FORM: 'POForm',
  PO_DETAIL: 'PODetail',
} as const;
