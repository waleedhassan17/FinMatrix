  ...
  <SafeAreaView style={styles.container} edges={['top']}>
    ...
    <View style={styles.body}>
      <View style={styles.iconCircle}>
        <Text style={styles.iconText}>TXN</Text>
      </View>
      <Text style={styles.heading}>Transactions Hub</Text>
      <Text style={styles.subtitle}>
        Invoices, bills, journal entries, and all financial transactions will be
        managed here.
      </Text>
    </View>
  </SafeAreaView>
