...
export const employees: EmployeeRecord[] = [
  {
    ...
    department: 'Finance', position: 'Senior Accountant', employmentType: 'full_time', status: 'active', startDate: '2024-01-10', payType: 'salary', salaryAmount: 185000, hourlyRate: 0, hoursPerWeek: 40,
  ...
  },
  {
    ...
    department: 'Sales', position: 'Sales Executive', employmentType: 'full_time', status: 'active', startDate: '2024-03-05', payType: 'salary', salaryAmount: 120000, hourlyRate: 0, hoursPerWeek: 40,
  ...
  },
  {
    ...
    department: 'IT', position: 'Systems Engineer', employmentType: 'full_time', status: 'active', startDate: '2023-11-15', payType: 'salary', salaryAmount: 210000, hourlyRate: 0, hoursPerWeek: 40,
  ...
  },
  {
    ...
    department: 'Human Resources', position: 'HR Business Partner', employmentType: 'full_time', status: 'on_leave', startDate: '2024-05-22', payType: 'salary', salaryAmount: 135000, hourlyRate: 0, hoursPerWeek: 40,
  ...
  },
  {
    ...
    department: 'Operations', position: 'Operations Coordinator', employmentType: 'full_time', status: 'active', startDate: '2025-01-08', payType: 'hourly', salaryAmount: 0, hourlyRate: 1450, hoursPerWeek: 45,
  ...
  },
  {
    ...
    department: 'Logistics', position: 'Warehouse Supervisor', employmentType: 'full_time', status: 'active', startDate: '2023-09-12', payType: 'salary', salaryAmount: 128000, hourlyRate: 0, hoursPerWeek: 40,
  ...
  },
  {
    ...
    department: 'Sales', position: 'Inside Sales Rep', employmentType: 'part_time', status: 'active', startDate: '2025-07-01', payType: 'hourly', salaryAmount: 0, hourlyRate: 1050, hoursPerWeek: 30,
  ...
  },
  {
    ...
    department: 'Finance', position: 'Payroll Specialist', employmentType: 'contract', status: 'active', startDate: '2025-10-20', payType: 'salary', salaryAmount: 98000, hourlyRate: 0, hoursPerWeek: 40,
  ...
  },
  {
    ...
    department: 'IT', position: 'Support Analyst', employmentType: 'full_time', status: 'active', startDate: '2024-08-04', payType: 'hourly', salaryAmount: 0, hourlyRate: 1250, hoursPerWeek: 42,
  ...
  },
  {
    ...
    department: 'Operations', position: 'Admin Assistant', employmentType: 'full_time', status: 'terminated', startDate: '2023-04-17', payType: 'salary', salaryAmount: 82000, hourlyRate: 0, hoursPerWeek: 40,
